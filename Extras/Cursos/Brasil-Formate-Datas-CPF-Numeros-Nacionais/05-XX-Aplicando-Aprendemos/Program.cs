...
Cláusula 1ª - O EMPREGADO prestará ao EMPREGADOR, a partir de (DATA DE INÍCIO) e assinatura deste instrumento, seus trabalhos exercendo a função de (CARGO), prestando pessoalmente o labor diário no período compreendido entre 9 horas às 18 horas, e intervalo de 1 hora para almoço;
