using _04_XX_Testes_Automatizados.API.Dados.Context;
using _04_XX_Testes_Automatizados.API.Dominio;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;
using Serilog;
using Serilog.Events;

namespace _04_XX_Testes_Automatizados.API.Controladores;
