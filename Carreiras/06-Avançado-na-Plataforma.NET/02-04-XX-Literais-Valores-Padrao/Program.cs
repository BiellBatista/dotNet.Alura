...
namespace _02_04_XX_Literais_Valores_Padrao
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            //try
            //{
            //    Console.WriteLine(await _02_04_XX_Literais_Valores_Padrao.R10.depois.MenuItem.GetGoogleAsync());
            //}
            //catch (Exception exc)
            //{
        ...
        private static void ExecutarPasso(int programa, string step)
        {
            ...
            var type = Type.GetType($"_02_04_XX_Literais_Valores_Padrao.R{programa:00}.{step}.MenuItem");
