...
namespace _01_03_XX_Strings_Mais_Inteligentes.R07
{
    class Programa
    {
        public void Main()
    ...
    class Aluno : INotifyPropertyChanged
    {
        ...
        //o atributo [CallerMemberName] serve para pegar o nome do objeto (nameof()) que está chamando este método e o atribui no parametro "propertyName"
