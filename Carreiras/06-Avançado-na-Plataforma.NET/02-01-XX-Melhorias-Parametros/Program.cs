...
namespace _02_01_XX_Melhorias_Parametros
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            //try
            //{
            //    Console.WriteLine(await _02_01_XX_Melhorias_Parametros.R10.depois.MenuItem.GetGoogleAsync());
            //}
            //catch (Exception exc)
            //{
        ...
        private static void ExecutarPasso(int programa, string step)
        {
            ...
            var type = Type.GetType($"_02_01_XX_Melhorias_Parametros.R{programa:00}.{step}.MenuItem");
