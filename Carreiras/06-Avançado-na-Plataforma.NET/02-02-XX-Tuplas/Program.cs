...
namespace _02_02_XX_Tuplas
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            //try
            //{
            //    Console.WriteLine(await _02_02_XX_Tuplas.R10.depois.MenuItem.GetGoogleAsync());
            //}
            //catch (Exception exc)
            //{
        ...
        private static void ExecutarPasso(int programa, string step)
        {
            ...
            var type = Type.GetType($"_02_02_XX_Tuplas.R{programa:00}.{step}.MenuItem");
