...
namespace _02_03_XX_Melhorias_Condicionais
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            //try
            //{
            //    Console.WriteLine(await _02_03_XX_Melhorias_Condicionais.R10.depois.MenuItem.GetGoogleAsync());
            //}
            //catch (Exception exc)
            //{
        ...
        private static void ExecutarPasso(int programa, string step)
        {
            ...
            var type = Type.GetType($"_02_03_XX_Melhorias_Condicionais.R{programa:00}.{step}.MenuItem");
