...
namespace _02_05_XX_Estilo_Codigo
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            //try
            //{
            //    Console.WriteLine(await _02_05_XX_Estilo_Codigo.R10.depois.MenuItem.GetGoogleAsync());
            //}
            //catch (Exception exc)
            //{
        ...
        private static void ExecutarPasso(int programa, string step)
        {
            ...
            var type = Type.GetType($"_02_05_XX_Estilo_Codigo.R{programa:00}.{step}.MenuItem");
