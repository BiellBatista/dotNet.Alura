...
namespace _05_05_XX_Ajustes_Finos_Conclusao.Infraestrutura
{
    public class ManipuladorRequisicaoController
    {
        ...
        public void Manipular(HttpListenerResponse resposta, string path)
        {
            ...
            var controllerNomeCompleto = $"_05_05_XX_Ajustes_Finos_Conclusao.Controller.{controllerNome}Controller";
            //var controllerWrapper = Activator.CreateInstance("_05_05_XX_Ajustes_Finos_Conclusao", controllerNomeCompleto, new object[0]);
