using _03_02_Refletindo_linguagem_negocio.API.Clientes;
using _03_02_Refletindo_linguagem_negocio.API.Conteineres;
using _03_02_Refletindo_linguagem_negocio.API.Contracts;
using _03_02_Refletindo_linguagem_negocio.API.Data;
using _03_02_Refletindo_linguagem_negocio.API.Data.Repositories;
using _03_02_Refletindo_linguagem_negocio.API.Domain;
using _03_02_Refletindo_linguagem_negocio.API.Identity;
using _03_02_Refletindo_linguagem_negocio.API.Locacoes;
using _03_02_Refletindo_linguagem_negocio.API.Propostas;
