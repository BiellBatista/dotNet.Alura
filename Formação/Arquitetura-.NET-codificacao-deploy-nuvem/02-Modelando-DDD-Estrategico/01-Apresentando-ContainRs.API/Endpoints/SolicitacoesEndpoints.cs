using _01_Apresentando_ContainRs.API.Contracts;
using _01_Apresentando_ContainRs.API.Domain;
using _01_Apresentando_ContainRs.API.Extensions;
using _01_Apresentando_ContainRs.API.Requests;
using _01_Apresentando_ContainRs.API.Responses;
using Microsoft.AspNetCore.Mvc;

namespace _01_Apresentando_ContainRs.API.Endpoints;
