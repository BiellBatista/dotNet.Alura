using _03_LINQ_sintaxe_consulta.WebApi.Models;
using Microsoft.AspNetCore.Mvc;
using Newtonsoft.Json;

namespace _03_LINQ_sintaxe_consulta.WebApi.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class ContaBancariaController : ControllerBase
    {
        ...
        private static ContaCorrente? GetContaCorrente(string agencia, string conta)
        {
            ...
            //return ContasCorrentes.Where(cc => cc.Agencia == agencia && cc.Conta == conta)
            //    .SingleOrDefault();
