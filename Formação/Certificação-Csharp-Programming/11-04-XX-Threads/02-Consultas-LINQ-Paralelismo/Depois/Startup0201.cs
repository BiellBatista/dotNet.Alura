...
namespace _11_04_XX_Threads.Depois
{
    public class Startup0201 : IAulaItem
    {
        public void Executar()
        {
            ...
            Thread thread1 = new Thread(Executar1);
        ...
        private void ExecutarComParametro(object param)
        {
            ExibirThread(Thread.CurrentThread);
        ...
        private void ExibirThread(Thread t)
        {
