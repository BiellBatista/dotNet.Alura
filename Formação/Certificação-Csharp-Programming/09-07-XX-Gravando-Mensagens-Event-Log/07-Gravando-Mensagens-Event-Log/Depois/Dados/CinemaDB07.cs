...
namespace _09_07_XX_Gravando_Mensagens_Event_Log.Depois
{
    public class CinemaDB07
    {
        ...
        public CinemaDB07(string databaseServer, string masterDatabase, string databaseName)
        {
        ...
        public async Task<IList<Filme07>> GetFilmes()
        {
            Trace.WriteLine("Entrando no método GetFilmes", "MÉTODO");
            Trace.Indent();

            IList<Filme07> filmes = new List<Filme07>();
...
#line hidden
                while (reader.Read())
                {
                    ...
                    filmes.Add(new Filme07(diretor, titulo));
                }
#line default
            }
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        [DebuggerStepThrough]
        private void ExibirFilmesJson(IList<Filme07> filmes)
        {
            Trace.WriteLine("O método GetFilmes() foi executado com sucesso. {0}", JsonConvert.SerializeObject(filmes));
        }

        [Conditional("MODO_DEBUG_DETALHADO")]
        private void ExibirFilmesJsonFormatado(IList<Filme07> filmes)
        {
