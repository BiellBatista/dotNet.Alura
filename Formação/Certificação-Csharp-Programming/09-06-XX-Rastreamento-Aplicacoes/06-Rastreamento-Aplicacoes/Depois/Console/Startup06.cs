...
namespace _09_06_XX_Rastreamento_Aplicacoes.Depois
{
    public class Startup06 : IAulaItem
    {
        ...
        {
            if (CinemaPerformance06.ConfigurarCategoria())
                return;

            CinemaPerformance06.CriarContadores();
            ...
            CinemaDB06 cinemaDB = await CriarBanco();
        ...
        private static async Task GerarRelatorio(CinemaDB06 cinemaDB)
        {
            ...
            CinemaPerformance06.ContadorAverageTimer32.IncrementBy(stopwatch.ElapsedTicks);
            CinemaPerformance06.ContadorAverageTimer32Base.Increment();
        }

        private static async Task<CinemaDB06> CriarBanco()
        {
