...
namespace _09_06_XX_Rastreamento_Aplicacoes.Depois
{
    public class CinemaDB04
    {
        ...
        public CinemaDB04(string databaseServer, string masterDatabase, string databaseName)
        {
        ...
        public async Task<IList<Filme04>> GetFilmes()
        {
            Trace.WriteLine("Entrando no método GetFilmes", "MÉTODO");
            Trace.Indent();

            IList<Filme04> filmes = new List<Filme04>();
...
#line hidden
                while (reader.Read())
                {
                    ...
                    filmes.Add(new Filme04(diretor, titulo));
                }
#line default
            }
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        [DebuggerStepThrough]
        private void ExibirFilmesJson(IList<Filme04> filmes)
        {
            Trace.WriteLine("O método GetFilmes() foi executado com sucesso. {0}", JsonConvert.SerializeObject(filmes));
        }

        [Conditional("MODO_DEBUG_DETALHADO")]
        private void ExibirFilmesJsonFormatado(IList<Filme04> filmes)
        {
