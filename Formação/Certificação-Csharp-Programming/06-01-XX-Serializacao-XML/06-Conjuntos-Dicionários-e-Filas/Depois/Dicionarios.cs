...
{
    public class Dicionarios : IAulaItem
    {
        public void Executar()
        {
            var esperanca = new Filme8("Episódio IV -Uma nova esperança", 1977);
            var imperio = new Filme8("Episódio V -O Império Contra-Ataca", 1980);
            var retorno = new Filme8("Episódio VI -O Retorno de Jedi", 1983);
            var ameaca = new Filme8("Episódio I: A Ameaça Fantasma", 1999);

            //DICIONÁRIO

            //declarando dicionário de filmes
            Dictionary<int, Filme8> filmes = new Dictionary<int, Filme8>();
            ...
            filmes.TryGetValue(34673, out Filme8 filme34673);
    ...
    public class Filme8 : IComparable
    {
        public Filme8(string titulo, int ano)
        {
            Titulo = titulo;
            Ano = ano;
        }
