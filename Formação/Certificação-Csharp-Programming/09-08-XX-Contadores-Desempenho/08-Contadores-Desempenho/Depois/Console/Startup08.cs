...
namespace _09_08_XX_Contadores_Desempenho.Depois
{
    public class Startup08 : IAulaItem
    {
        ...
        {
            if (CinemaPerformance08.ConfigurarCategoria())
                return;

            CinemaPerformance08.CriarContadores();
            ...
            CinemaDB08 cinemaDB = await CriarBanco();
        ...
        private static async Task GerarRelatorio(CinemaDB08 cinemaDB)
        {
            ...
            CinemaPerformance08.ContadorAverageTimer32.IncrementBy(stopwatch.ElapsedTicks);
            CinemaPerformance08.ContadorAverageTimer32Base.Increment();
        }

        private static async Task<CinemaDB08> CriarBanco()
        {
