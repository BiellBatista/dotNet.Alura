...
namespace _09_08_XX_Contadores_Desempenho.Depois
{
    public class Startup07 : IAulaItem
    {
        ...
        {
            if (CinemaPerformance07.ConfigurarCategoria())
                return;

            CinemaPerformance07.CriarContadores();
            ...
            CinemaDB07 cinemaDB = await CriarBanco();
        ...
        private static async Task GerarRelatorio(CinemaDB07 cinemaDB)
        {
            ...
            CinemaPerformance07.ContadorAverageTimer32.IncrementBy(stopwatch.ElapsedTicks);
            CinemaPerformance07.ContadorAverageTimer32Base.Increment();
        }

        private static async Task<CinemaDB07> CriarBanco()
        {
