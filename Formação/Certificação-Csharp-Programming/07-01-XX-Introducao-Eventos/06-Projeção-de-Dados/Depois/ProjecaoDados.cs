...
namespace _07_01_XX_Introducao_Eventos.Depois
{
    public class ProjecaoDados : IAulaItem
    {
        ...
        private void Imprimir(IEnumerable<Filme2> filmes)
        {
        ...
        private void Imprimir(IEnumerable<FilmeResumido> filmes)
        {
            Console.WriteLine($"{"Título",-40} {"Diretor",-20}");
            Console.WriteLine(new string('=', 64));
            foreach (var filme in filmes)
