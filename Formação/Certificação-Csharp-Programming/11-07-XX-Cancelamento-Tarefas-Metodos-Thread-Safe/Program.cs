using _11_07_XX_Cancelamento_Tarefas_Metodos_Thread_Safe.Depois;
using System;
using System.Collections.Generic;

namespace _11_07_XX_Cancelamento_Tarefas_Metodos_Thread_Safe
{
    public class Program
    {
        ...
        private static IList<MenuItem> GetMenuItems()
        {
            return new List<MenuItem>
            {
                ...
                new MenuItem("Desbloqueando a Interface do Usuário", typeof(Startup0501)),
                new MenuItem("Desbloqueando a Interface do Usuário", typeof(Startup0502)),
                new MenuItem("Desbloqueando a Interface do Usuário", typeof(Startup0503)),
                new MenuItem("Async, Await, Coleções Simultâneas e Bloqueios", typeof(Startup0601)),
                new MenuItem("Cancelamento de Tarefas e Métodos Thread Safe", typeof(Startup0701)),
                new MenuItem("Cancelamento de Tarefas e Métodos Thread Safe", typeof(Startup0702)),
                new MenuItem("Cancelamento de Tarefas e Métodos Thread Safe", typeof(Startup0703)),
            };
        }
    }
