...
internal class ProjetoTypeConfiguration : IEntityTypeConfiguration<Projeto>
{
    public void Configure(EntityTypeBuilder<Projeto> entity)
    {
        ...
        entity
            ...
            l => l.HasOne(e => e.Especialidade).WithMany(e => e.ProjetosEspecialidades).HasForeignKey(e => e.EspecialidadeId),
            r => r.HasOne(e => e.Projeto).WithMany(e => e.ProjetosEspecialidades).HasForeignKey(e => e.ProjetoId)
            );
    }
}