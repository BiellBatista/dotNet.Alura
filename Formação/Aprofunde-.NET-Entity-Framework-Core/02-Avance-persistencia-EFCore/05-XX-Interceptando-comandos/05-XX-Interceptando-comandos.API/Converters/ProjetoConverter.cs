using _05_XX_Interceptando_comandos.API.Requests;
using _05_XX_Interceptando_comandos.API.Responses;
using _05_XX_Interceptando_comandos.Modelos;

namespace _05_XX_Interceptando_comandos.API.Converters;
