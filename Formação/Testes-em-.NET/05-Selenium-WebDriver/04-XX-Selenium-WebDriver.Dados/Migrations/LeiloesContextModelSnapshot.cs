...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_04_XX_Selenium_WebDriver.Core.Favorito", b =>
                {
            ...
            modelBuilder.Entity("_04_XX_Selenium_WebDriver.Core.Interessada", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("_04_XX_Selenium_WebDriver.Core.Lance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("_04_XX_Selenium_WebDriver.Core.Leilao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("_04_XX_Selenium_WebDriver.Core.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("_04_XX_Selenium_WebDriver.Core.Favorito", b =>
                {
                    b.HasOne("_04_XX_Selenium_WebDriver.Core.Interessada", "Seguidor")
                        .WithMany("Favoritos")
                        .HasForeignKey("IdInteressada")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("_04_XX_Selenium_WebDriver.Core.Leilao", "LeilaoFavorito")
                        .WithMany("Seguidores")
            ...
            modelBuilder.Entity("_04_XX_Selenium_WebDriver.Core.Lance", b =>
                {
                    b.HasOne("_04_XX_Selenium_WebDriver.Core.Interessada", "Cliente")
                        .WithMany("Lances")
                        .HasForeignKey("ClienteId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("_04_XX_Selenium_WebDriver.Core.Leilao", "Leilao")
                        .WithMany("Lances")
            ...
            modelBuilder.Entity("_04_XX_Selenium_WebDriver.Core.Leilao", b =>
                {
                    b.HasOne("_04_XX_Selenium_WebDriver.Core.Lance", "Ganhador")
                        .WithMany()
            ...
            modelBuilder.Entity("_04_XX_Selenium_WebDriver.Core.Usuario", b =>
                {
                    b.HasOne("_04_XX_Selenium_WebDriver.Core.Interessada", "Interessada")
                        .WithMany()
