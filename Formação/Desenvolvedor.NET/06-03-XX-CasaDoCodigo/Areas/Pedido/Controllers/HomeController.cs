...
using _06_03_XX_CasaDoCodigo.Repositories;
...
namespace _06_03_XX_CasaDoCodigo.Areas.Pedido.Controllers
{
    [Area("Pedido")]
    public class HomeController : Controller
    {
        ...
        [Authorize]
        public async Task<IActionResult> Index(_06_03_XX_CasaDoCodigo.Models.Cadastro cadastro)
        {
